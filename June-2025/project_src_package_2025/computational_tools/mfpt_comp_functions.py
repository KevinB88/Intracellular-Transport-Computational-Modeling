...
@njit(nopython=ENABLE_JIT, cache=ENABLE_CACHE)
def comp_mfpt_by_mass_loss_rect(rg_param, ry_param, switch_param_a, switch_param_b, v_param, N_LIST, D_LAYER, A_LAYER,
                                mass_checkpoint=10**6, domain_radius=1.0, D=1.0, mass_retention_threshold=0.01, d_tube=0.0):
