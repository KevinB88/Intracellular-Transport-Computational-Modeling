...
def comp_diffusive_snapshots(rings, rays, a, b, v, tube_placements, diffusive_layer, advective_layer,
                             ...
                             mfpt_container=None,
                             mass_checkpoint=10 ** 6, mixed_config=False):
    if ENABLE_JIT:
        print("Running optimized version.")
...
def comp_diffusive_rad_snapshots(rings, rays, a, b, v, tube_placements, diffusive_layer, advective_layer,
                                 ...
                                 mass_retention_threshold=0.01, mass_checkpoint=10 ** 6, mixed_config=False):
    if ENABLE_JIT:
        print("Running optimized version.")
...
'''
collect special diffusive angles (along with attributed filaments)
using the dictionary code
