...
# Diffusive updates using the rectangular geometry
@njit(nopython=ENABLE_JIT)
def u_density_rec(phi, k, m, n, d_radius, d_theta, d_time, central, rings, rho, mt_pos, a, b, tube_placements, j_max):
    ...
    # update this line to be within the zone of exchange
    if n == tube_placements[mt_pos]:
...
@njit(nopython=ENABLE_JIT)
def u_tube_rec(rho, phi, k, m, n, a, b, v, d_time, d_radius, d_theta, j_max):
    """
